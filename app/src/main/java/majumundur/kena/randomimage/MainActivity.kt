package majumundur.kena.randomimage
...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar( txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.na1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.na2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.na3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.na4))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.na5))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.na6))
            }
        }
    }
